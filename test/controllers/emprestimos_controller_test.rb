...
class EmprestimosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create emprestimo" do
    assert_difference("Emprestimo.count") do
      post emprestimos_url, params: { emprestimo: { data_devolucao_prevista: @emprestimo.data_devolucao_prevista, data_emprestimo: @emprestimo.data_emprestimo, livro_id: @emprestimo.livro_id, status: @emprestimo.status, usuario_id: @emprestimo.usuario_id } }
    end
  ...
  test "should update emprestimo" do
    patch emprestimo_url(@emprestimo), params: { emprestimo: { data_devolucao_prevista: @emprestimo.data_devolucao_prevista, data_emprestimo: @emprestimo.data_emprestimo, livro_id: @emprestimo.livro_id, status: @emprestimo.status, usuario_id: @emprestimo.usuario_id } }
